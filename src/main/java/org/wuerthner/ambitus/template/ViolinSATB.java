...
public class ViolinSATB implements Template {
    public static final String NAME = "Violin + SATB";
    ...
    public Arrangement apply(int key, int tempo, TimeSignature timeSignature, ModelElementFactory factory) {
        ...
        MidiTrack violin = factory.createElement(MidiTrack.TYPE);
        violin.performTransientSetAttributeValueOperation(MidiTrack.name, VIOLIN);
        violin.performTransientSetAttributeValueOperation(MidiTrack.channel, 0);
        init(arrangement, violin, 0, key, tempo, timeSignature, factory);
        ...
        sopran.performTransientSetAttributeValueOperation(MidiTrack.channel, 1);
        init(arrangement, sopran, 0, key, timeSignature, factory);

        MidiTrack alt = factory.createElement(MidiTrack.TYPE);
        alt.performTransientSetAttributeValueOperation(MidiTrack.name, ALT);
        alt.performTransientSetAttributeValueOperation(MidiTrack.channel, 2);
        ...
        tenor.performTransientSetAttributeValueOperation(MidiTrack.channel, 3);
        ...
        bass.performTransientSetAttributeValueOperation(MidiTrack.channel, 4);
